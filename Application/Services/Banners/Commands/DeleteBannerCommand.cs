...
public class DeleteBannerCommand : IRequest<ResponseHelper>
{
    public int Id { get; set; }
}

public class DeleteBannerCommandHandler : IRequestHandler<DeleteBannerCommand, ResponseHelper>
{

    private readonly IApplicationDbContext _context;
    private readonly IMapper _mapper;

    public DeleteBannerCommandHandler(IApplicationDbContext context, IMapper mapper)
    {
        _context = context;
        _mapper = mapper;
    }
    public async Task<ResponseHelper> Handle(DeleteBannerCommand request, CancellationToken cancellationToken)
    {
        try
        {
